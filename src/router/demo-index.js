export {default as Home} from '../pages/HomePage/Home.vue'

export const Category = r => require.ensure([], () => r(require('../pages/categoryPage/category')), 'category')
...
export const NumberKeyboard = r => require.ensure([], () => r(require('../components/number-keyboard/demo')), 'number-keyboard')
